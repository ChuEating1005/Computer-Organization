...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+58,"MuxPC_Out", false,-1, 31,0);
    tracep->declBus(c+3,"MuxSelA_Out", false,-1, 31,0);
    tracep->declBus(c+4,"MuxSelB_Out", false,-1, 31,0);
    ...
    tracep->declBit(c+12,"PCSel", false,-1);
    tracep->declBit(c+60,"memRead", false,-1);
    tracep->declBit(c+13,"memWrite", false,-1);
    tracep->declBit(c+14,"SelA", false,-1);
    tracep->declBit(c+15,"SelB", false,-1);
    tracep->declBit(c+16,"regWrite", false,-1);
    tracep->declBit(c+17,"BrLt", false,-1);
    tracep->declBit(c+18,"BrEq", false,-1);
    ...
    tracep->declBus(c+10,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+19,"funct7", false,-1);
    ...
    tracep->declBit(c+15,"SelB", false,-1);
    tracep->declBit(c+16,"regWrite", false,-1);
    tracep->declBus(c+22,"ctrl", false,-1, 9,0);
    tracep->popNamePrefix(1);
    ...
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_Mux_SelA ");
    tracep->declBus(c+98,"size", false,-1, 31,0);
    ...
    tracep->declBus(c+25,"writeReg", false,-1, 4,0);
    tracep->declBus(c+95,"writeData", false,-1, 31,0);
    tracep->declBus(c+7,"readData1", false,-1, 31,0);
    tracep->declBus(c+8,"readData2", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+26+i*1,"regs", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__MuxSelA_Out),32);
    bufp->fullIData(oldp+4,(vlSelf->SingleCycleCPU__DOT__MuxSelB_Out),32);
    ...
    bufp->fullCData(oldp+9,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    ...
    bufp->fullBit(oldp+17,((vlSelf->SingleCycleCPU__DOT__readData1 
                            < vlSelf->SingleCycleCPU__DOT__readData2)));
    bufp->fullBit(oldp+18,((vlSelf->SingleCycleCPU__DOT__readData1 
                            == vlSelf->SingleCycleCPU__DOT__readData2)));
    bufp->fullBit(oldp+19,(((0x80U > vlSelf->SingleCycleCPU__DOT__PC) 
                            & ((IData)(vlSelf->__VdfgTmp_h00ca03af__0) 
                               >> 6U))));
    bufp->fullCData(oldp+20,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__funct3),3);
    bufp->fullCData(oldp+21,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Control__opcode),7);
    bufp->fullSData(oldp+22,(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl),10);
    bufp->fullCData(oldp+23,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h30fffff8__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+24,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h75522435__0 
                                                >> 0x14U)))),5);
    bufp->fullCData(oldp+25,(vlSelf->SingleCycleCPU__DOT____Vcellinp__m_Register__writeReg),5);
    bufp->fullIData(oldp+26,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[0]),32);
    bufp->fullIData(oldp+27,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[1]),32);
    bufp->fullIData(oldp+28,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[2]),32);
    bufp->fullIData(oldp+29,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[3]),32);
    bufp->fullIData(oldp+30,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[4]),32);
    bufp->fullIData(oldp+31,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[5]),32);
    bufp->fullIData(oldp+32,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[6]),32);
    bufp->fullIData(oldp+33,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[7]),32);
    bufp->fullIData(oldp+34,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[8]),32);
    bufp->fullIData(oldp+35,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[9]),32);
    bufp->fullIData(oldp+36,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[10]),32);
    bufp->fullIData(oldp+37,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[11]),32);
    bufp->fullIData(oldp+38,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[12]),32);
    bufp->fullIData(oldp+39,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[13]),32);
    bufp->fullIData(oldp+40,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[14]),32);
    bufp->fullIData(oldp+41,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[15]),32);
    bufp->fullIData(oldp+42,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[16]),32);
    bufp->fullIData(oldp+43,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[17]),32);
    bufp->fullIData(oldp+44,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[18]),32);
    bufp->fullIData(oldp+45,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[19]),32);
    bufp->fullIData(oldp+46,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[20]),32);
    bufp->fullIData(oldp+47,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[21]),32);
    bufp->fullIData(oldp+48,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[22]),32);
    bufp->fullIData(oldp+49,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[23]),32);
    bufp->fullIData(oldp+50,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[24]),32);
    bufp->fullIData(oldp+51,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[25]),32);
    bufp->fullIData(oldp+52,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[26]),32);
    bufp->fullIData(oldp+53,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[27]),32);
    bufp->fullIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[28]),32);
    bufp->fullIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[29]),32);
    bufp->fullIData(oldp+56,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[30]),32);
    bufp->fullIData(oldp+57,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[31]),32);
    bufp->fullIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__MuxPC_Out),32);
    bufp->fullIData(oldp+59,(vlSelf->SingleCycleCPU__DOT__ALU_Out),32);
    bufp->fullBit(oldp+60,(vlSelf->SingleCycleCPU__DOT__memRead));
    ...
    bufp->fullIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__readData),32);
