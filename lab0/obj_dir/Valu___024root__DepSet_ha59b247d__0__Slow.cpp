...
#endif
                VL_FATAL_MT("part2/alu.v", 4, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->alu__DOT__ADD__DOT____Vcellinp__fa1____pinNumber1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__ADD__DOT____Vcellinp__fa2____pinNumber1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__ADD__DOT____Vcellinp__fa3____pinNumber1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__SUB__DOT____Vcellinp__fa1____pinNumber1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__SUB__DOT____Vcellinp__fa2____pinNumber1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__SUB__DOT____Vcellinp__fa3____pinNumber1 = VL_RAND_RESET_I(1);
