...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"MuxSelB_Out", false,-1, 31,0);
    ...
    tracep->declBus(c+7,"inst_IF", false,-1, 31,0);
    tracep->declBus(c+8,"inst_ID", false,-1, 31,0);
    tracep->declBus(c+9,"writeReg_EX", false,-1, 4,0);
    tracep->declBus(c+10,"writeReg_MEM", false,-1, 4,0);
    tracep->declBus(c+72,"writeReg_WB", false,-1, 4,0);
    tracep->declBus(c+113,"rs1_ID", false,-1, 31,0);
    tracep->declBus(c+11,"rs1_EX", false,-1, 31,0);
    tracep->declBus(c+114,"rs2_ID", false,-1, 31,0);
    tracep->declBus(c+12,"rs2_EX", false,-1, 31,0);
    tracep->declBus(c+13,"rs2_MEM", false,-1, 31,0);
    tracep->declBus(c+14,"imm_ID", false,-1, 31,0);
    tracep->declBus(c+15,"imm_EX", false,-1, 31,0);
    tracep->declBus(c+16,"ALUOut_EX", false,-1, 31,0);
    ...
    tracep->declBit(c+17,"memRead_ID", false,-1);
    tracep->declBit(c+18,"memRead_EX", false,-1);
    tracep->declBit(c+76,"memRead_MEM", false,-1);
    tracep->declBit(c+19,"memWrite_ID", false,-1);
    tracep->declBit(c+20,"memWrite_EX", false,-1);
    tracep->declBit(c+21,"memWrite_MEM", false,-1);
    tracep->declBit(c+22,"memtoReg_ID", false,-1);
    tracep->declBit(c+23,"memtoReg_EX", false,-1);
    tracep->declBit(c+24,"memtoReg_MEM", false,-1);
    tracep->declBit(c+77,"memtoReg_WB", false,-1);
    tracep->declBit(c+25,"regWrite_ID", false,-1);
    tracep->declBit(c+26,"regWrite_EX", false,-1);
    tracep->declBit(c+27,"regWrite_MEM", false,-1);
    tracep->declBit(c+78,"regWrite_WB", false,-1);
    tracep->declBus(c+28,"ALUOp_ID", false,-1, 1,0);
    tracep->declBus(c+29,"ALUOp_EX", false,-1, 1,0);
    tracep->declBit(c+30,"SelB_ID", false,-1);
    tracep->declBit(c+31,"SelB_EX", false,-1);
    ...
    tracep->declBus(c+29,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+5,"funct7", false,-1);
    tracep->declBus(c+6,"funct3", false,-1, 2,0);
    tracep->declBus(c+4,"ALUCtl", false,-1, 3,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+17,"memRead", false,-1);
    tracep->declBit(c+22,"memtoReg", false,-1);
    tracep->declBus(c+28,"ALUOp", false,-1, 1,0);
    tracep->declBit(c+19,"memWrite", false,-1);
    tracep->declBit(c+30,"SelB", false,-1);
    tracep->declBit(c+25,"regWrite", false,-1);
    tracep->declBus(c+33,"ctrl", false,-1, 6,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+13,"writeData", false,-1, 31,0);
    tracep->declBus(c+115,"readData", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_EXReg ");
    tracep->declBit(c+79,"clk", false,-1);
    tracep->declBit(c+80,"rst", false,-1);
    tracep->declBit(c+17,"memRead_in", false,-1);
    tracep->declBit(c+19,"memWrite_in", false,-1);
    tracep->declBit(c+22,"memtoReg_in", false,-1);
    tracep->declBit(c+25,"regWrite_in", false,-1);
    tracep->declBus(c+28,"ALUOp_in", false,-1, 1,0);
    tracep->declBit(c+30,"SelB_in", false,-1);
    tracep->declBus(c+113,"rs1_in", false,-1, 31,0);
    tracep->declBus(c+114,"rs2_in", false,-1, 31,0);
    tracep->declBus(c+14,"imm_in", false,-1, 31,0);
    tracep->declBit(c+34,"funct7_in", false,-1);
    tracep->declBus(c+35,"funct3_in", false,-1, 2,0);
    tracep->declBus(c+36,"writeReg_in", false,-1, 4,0);
    tracep->declBit(c+18,"memRead_out", false,-1);
    tracep->declBit(c+20,"memWrite_out", false,-1);
    tracep->declBit(c+23,"memtoReg_out", false,-1);
    tracep->declBit(c+26,"regWrite_out", false,-1);
    tracep->declBus(c+29,"ALUOp_out", false,-1, 1,0);
    tracep->declBit(c+31,"SelB_out", false,-1);
    tracep->declBus(c+11,"rs1_out", false,-1, 31,0);
    tracep->declBus(c+12,"rs2_out", false,-1, 31,0);
    tracep->declBus(c+15,"imm_out", false,-1, 31,0);
    tracep->declBit(c+5,"funct7_out", false,-1);
    tracep->declBus(c+6,"funct3_out", false,-1, 2,0);
    tracep->declBus(c+9,"writeReg_out", false,-1, 4,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_IDReg ");
    tracep->declBit(c+79,"clk", false,-1);
    tracep->declBit(c+80,"rst", false,-1);
    tracep->declBus(c+7,"inst_in", false,-1, 31,0);
    tracep->declBus(c+8,"inst_out", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+79,"clk", false,-1);
    tracep->declBit(c+80,"rst", false,-1);
    tracep->declBit(c+18,"memRead_in", false,-1);
    tracep->declBit(c+20,"memWrite_in", false,-1);
    tracep->declBit(c+23,"memtoReg_in", false,-1);
    tracep->declBit(c+26,"regWrite_in", false,-1);
    tracep->declBus(c+16,"ALUResult_in", false,-1, 31,0);
    tracep->declBus(c+12,"rs2_in", false,-1, 31,0);
    tracep->declBus(c+9,"writeReg_in", false,-1, 4,0);
    tracep->declBit(c+76,"memRead_out", false,-1);
    tracep->declBit(c+21,"memWrite_out", false,-1);
    tracep->declBit(c+24,"memtoReg_out", false,-1);
    tracep->declBit(c+27,"regWrite_out", false,-1);
    tracep->declBus(c+73,"ALUResult_out", false,-1, 31,0);
    tracep->declBus(c+13,"rs2_out", false,-1, 31,0);
    tracep->declBus(c+10,"writeReg_out", false,-1, 4,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("m_Mux_SelB ");
    tracep->declBus(c+117,"size", false,-1, 31,0);
    tracep->declBit(c+31,"sel", false,-1);
    ...
    tracep->declBit(c+79,"clk", false,-1);
    tracep->declBit(c+80,"rst", false,-1);
    tracep->declBit(c+24,"memtoReg_in", false,-1);
    tracep->declBit(c+27,"regWrite_in", false,-1);
    tracep->declBus(c+73,"ALUResult_in", false,-1, 31,0);
    tracep->declBus(c+115,"readData_in", false,-1, 31,0);
    tracep->declBus(c+10,"writeReg_in", false,-1, 4,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__MuxSelB_Out),32);
    bufp->fullCData(oldp+4,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    bufp->fullBit(oldp+5,(vlSelf->SingleCycleCPU__DOT__funct7));
    bufp->fullCData(oldp+6,(vlSelf->SingleCycleCPU__DOT__funct3),3);
    bufp->fullIData(oldp+7,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
    ...
    bufp->fullIData(oldp+8,(vlSelf->SingleCycleCPU__DOT__inst_ID),32);
    bufp->fullCData(oldp+9,(vlSelf->SingleCycleCPU__DOT__writeReg_EX),5);
    bufp->fullCData(oldp+10,(vlSelf->SingleCycleCPU__DOT__writeReg_MEM),5);
    bufp->fullIData(oldp+11,(vlSelf->SingleCycleCPU__DOT__rs1_EX),32);
    bufp->fullIData(oldp+12,(vlSelf->SingleCycleCPU__DOT__rs2_EX),32);
    bufp->fullIData(oldp+13,(vlSelf->SingleCycleCPU__DOT__rs2_MEM),32);
    bufp->fullIData(oldp+14,(vlSelf->SingleCycleCPU__DOT__imm_ID),32);
    bufp->fullIData(oldp+15,(vlSelf->SingleCycleCPU__DOT__imm_EX),32);
    bufp->fullIData(oldp+16,(((0U == (IData)(vlSelf->SingleCycleCPU__DOT__ALUCtl))
                                       ...
                                       : ((6U == (IData)(vlSelf->SingleCycleCPU__DOT__ALUCtl))
                                           ...
                                           : ((7U == (IData)(vlSelf->SingleCycleCPU__DOT__ALUCtl))
                                               ? (VL_LTS_III(32, vlSelf->SingleCycleCPU__DOT__rs1_EX, vlSelf->SingleCycleCPU__DOT__MuxSelB_Out)
                                                   ...
                                                   : 0U)
                                               : 0U)))))),32);
    bufp->fullBit(oldp+17,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 6U))));
    bufp->fullBit(oldp+18,(vlSelf->SingleCycleCPU__DOT__memRead_EX));
    bufp->fullBit(oldp+19,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 2U))));
    bufp->fullBit(oldp+20,(vlSelf->SingleCycleCPU__DOT__memWrite_EX));
    bufp->fullBit(oldp+21,(vlSelf->SingleCycleCPU__DOT__memWrite_MEM));
    bufp->fullBit(oldp+22,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 5U))));
    bufp->fullBit(oldp+23,(vlSelf->SingleCycleCPU__DOT__memtoReg_EX));
    bufp->fullBit(oldp+24,(vlSelf->SingleCycleCPU__DOT__memtoReg_MEM));
    bufp->fullBit(oldp+25,((1U & (IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl))));
    bufp->fullBit(oldp+26,(vlSelf->SingleCycleCPU__DOT__regWrite_EX));
    bufp->fullBit(oldp+27,(vlSelf->SingleCycleCPU__DOT__regWrite_MEM));
    bufp->fullCData(oldp+28,((3U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                    >> 3U))),2);
    bufp->fullCData(oldp+29,(vlSelf->SingleCycleCPU__DOT__ALUOp_EX),2);
    bufp->fullBit(oldp+30,((1U & ((IData)(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl) 
                                  >> 1U))));
    bufp->fullBit(oldp+31,(vlSelf->SingleCycleCPU__DOT__SelB_EX));
    bufp->fullCData(oldp+32,((0x7fU & vlSelf->SingleCycleCPU__DOT__inst_ID)),7);
    bufp->fullCData(oldp+33,(vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl),7);
    bufp->fullBit(oldp+34,((1U & (vlSelf->SingleCycleCPU__DOT__inst_ID 
                                  >> 0x1eU))));
    bufp->fullCData(oldp+35,((7U & (vlSelf->SingleCycleCPU__DOT__inst_ID 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+36,((0x1fU & (vlSelf->SingleCycleCPU__DOT__inst_ID 
                                       >> 7U))),5);
    bufp->fullCData(oldp+37,((0x1fU & (vlSelf->SingleCycleCPU__DOT__inst_ID 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+38,((0x1fU & (vlSelf->SingleCycleCPU__DOT__inst_ID 
                                       >> 0x14U))),5);
